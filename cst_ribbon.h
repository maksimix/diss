...
enum class RibbonIcon
{
    ...
    Iris,
    RoundIris,
    // Свободные формы: примитивы, правка тела и готовые вставки из них.
    Brick,
    Cylinder,
    Prism,
    Boolean,
    ...
    MathHelp,         // математика расчёта — лист с формулой и знаком вопроса
    Grid,             // координатная сетка сцены
    Background        // светлый или тёмный фон сцены
};
