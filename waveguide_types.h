...
struct WaveguideParameters
{
    ...
    // Как рисуется корпус тракта: 0 — автоматически (светлеет, когда в дереве
    // выбрано тело или пластина), 1 — сплошной, 2 — полупрозрачный, 3 — каркас.
    // Свойство отображения, а не физики: на расчёт не влияет, но живёт в модели,
    // чтобы выбранный вид сохранялся вместе с проектом.
    int shell_display = 0;
